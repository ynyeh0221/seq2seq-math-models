...
def generate_division_data(num_samples=50000, max_val=100):
    data = []
    for _ in range(num_samples):
        b = random.randint(1, max_val)  # TODO: Handle division by zero cases later
...
train_data = generate_division_data(50000)
