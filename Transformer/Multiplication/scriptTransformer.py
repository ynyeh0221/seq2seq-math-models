...
# Function to generate multiplication data
def generate_multiplication_data(num_samples=10000, max_val=99):
    data = []
...
train_data = generate_multiplication_data(10000)
test_data = generate_multiplication_data(500)
